...
<html>
    ...
    <head>
        ...
        $(document).ready(function(){
            $("#type-search").change(function(){
                ...
                location.href = "home.php?option="+option;
    ...
    <body>
        ...
        <div id="contenedor">
            ...
            <div class="cont_site">
                <div class="prin_img">
                    <a href="beers.php" class="item-pring">
                ...
                <div class="prin_img">
                    <a href="producers.php" class="item-pring">
                ...
                <div class="prin_img">
                    <a href="raw.php" class="item-pring">
...
<?php if (isset($_SESSION['idUser'])) { ?>
                            ...
                            <?php } else { ?>
                                <span class="user_list" style="text-align: center !important; display: block; margin: 0;">RECOMMENDED USERS.<a href="#"><span class="user_name">LOG IN</span></a><br>TO MEET PEOPLE WITH SIMILAR TASTES.. </span>
<?php } ?>
                        </div>
                    </div>
