	...
	<div id="contenedor">
		...
		<div class="top_img">
			<img src="../../images/large.jpg" alt="Imagen The Beer Fans Principal" title="Imagen The Beer Fans Principal">
				<span class="text_prin bottom_text">CONTACT</span>
		</div>
		...
		<div class="content_contact">
  		...
  		<div class="input_contact">
					...
					<div class="input_form">
						<form id="formContactEng">
						  	<p class="name_form">NAME:<input required type="text" name="name"></p>
						  	<p class="email_form">EMAIL:<input required type="email" name="email"></p>
						  	<p class="message_form">MESSAGE: <textarea required name="message" rows="8" cols="40"></textarea> </p>
								<br>
