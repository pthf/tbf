...
<html>
    <head>
        ...
        <title>Beers | The Beer Fans | Social Network</title>
        ...
        $(document).ready(function(){
            $("#type-search").change(function(){
                ...
                location.href = "beers.php?option="+option;
    ...
    <body>
            ...
            <div class="menu_list">
                <?php if (isset($_SESSION['idUser'])) { ?>
                    <ul>
                        ...
                        <a href="../esp/cervezas.php"class="changeLanguage"><li><span>ESPAÑOL</span></li></a>
        ...
        <div id="contenedor">
            ...
            <div class="top_img">
                ...
                <span class="text_prin bottom_text">BEERS</span>
            </div>

            <div class="beer_info">
                <span class="title_beer_info">LEARN SOMETHING NEW</span>
                ...
                <div class="content buscar_beers">
                    ...
                    <div class="slides">
                        <div class="overflow">
                        	...
                        	<?php
                        		if (isset($_GET['type'])) {
		                          	$query_type = "SELECT * FROM beertype bt INNER JOIN beer b ON b.idbeertype = bt.idbeertype WHERE b.language = ".$_SESSION['language']." AND bt.beerTypeName ='" . $_GET['type'] . "'";
	                                $resultado_type = mysql_query($query_type) or die(mysql_error());
	                          		...
	                          		$query_country = "SELECT * FROM beer b
