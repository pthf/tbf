...
<html>
    <head>
        ...
        <title>Producers | The Beer Fans | Social Network</title>
						...
						<div class="menu_list">
								<?php if (isset($_SESSION['idUser'])) { ?>
										<ul>
												...
												<a href="../esp/perfil_empresa.php?id=<?= $_GET['id'] ?>" class="changeLanguage"><li><span>ESPAÑOL</span></li></a>
            ...
            <div class="favs_profile favs_profile_beer">
                ...
                <div class="back_ profile_back">
                    <a href="beers.php">
                        ...
                        <p class="back_text">GO TO PRODUCERS</p>
                    </a>
                </div>

                <div class="slides">
                    <div class="toptext_slider"><span>PRODUCTS</span></div>
                    <div class="overflow">
