		...
		<form class="form-horizontal" id="formBeer" name="formBeerData" enctype="multipart/form-data">
			<div class="col-md-5">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input disabled required type="text" class="form-control" id="id-producer" name="id" value="{{dataProducer[0].idProducer}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-name" class="col-sm-4 control-label">Name *</label>
					<div class="col-sm-8">
						<input required type="text" class="form-control" id="producer-name" placeholder="Insert producer name" name="name" value="{{dataProducer[0].producerName}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-description" class="col-sm-4 control-label">Description *</label>
					<div class="col-sm-8">
						<textarea required type="text" class="form-control" id="producer-description" placeholder="Insert producer description" style="height: 120px" name="description">{{dataProducer[0].producerDescription}}</textarea>
					</div>
				</div>
				<div class="form-group">
						...
						<select required class="form-control" id="producer-type" name="type">
							...
							<?php
								...
								while ($line = mysql_fetch_array($result)) {
									echo '<option value="'.$line["idProducerType"].'" name="'.$line["idProducerType"].'" ng-selected="dataProducer[0].idProducerType == '.$line["idProducerType"].'">'.$line["producerTypeName"].'</option>';
								}
							?>
						</select>
						<div class="col-sm-12">
					...
					<div class="col-sm-8">
						<select required class="form-control" id="producer-country" name="country">
							...
							<?php
								...
								$result = mysql_query($query) or die(mysql_error());
								while ($line = mysql_fetch_array($result)) {
									echo '<option value="'.$line["id"].'" name="'.$line["id"].'" ng-selected="dataProducer[0].country_id == '.$line["id"].'">'.$line["name_c"].'</option>';
								}
							?>
						</select>
					</div>
					...
					<div class="col-sm-8">
						<select required class="form-control" id="producer-state" name="state">
							...
							<?php
								...
								$result = mysql_query($query) or die(mysql_error());
								while ($line = mysql_fetch_array($result)) {
									echo '<option value="'.$line["id"].'" name="'.$line["id"].'" ng-selected="dataProducer[0].state_id == '.$line["id"].'">'.$line["name_s"].'</option>';
								}
							?>
						</select>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input required type="number" class="form-control" id="producer-zip" placeholder="Insert producer zip" name="zip" value="{{dataProducer[0].producerZip}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-phone" class="col-sm-4 control-label">Phone *</label>
					<div class="col-sm-8">
						<input required type="number" class="form-control" id="producer-phone" placeholder="Insert producer phone" name="phone" value="{{dataProducer[0].producerPhone}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-email" class="col-sm-4 control-label">Email *</label>
					<div class="col-sm-8">
						<input required type="email" class="form-control" id="producer-email" placeholder="Insert producer email" name="email" value="{{dataProducer[0].producerEmail}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-site" class="col-sm-4 control-label">Site</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="producer-site" placeholder="Insert URL" name="site" value="{{dataProducer[0].producerSite}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-fb" class="col-sm-4 control-label">Facebook</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="producer-fb" placeholder="Insert URL" name="facebook" value="{{dataProducer[0].producerFacebook}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-tw" class="col-sm-4 control-label">Twitter</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="producer-tw" placeholder="Insert URL" name="twitter" value="{{dataProducer[0].producerTwitter}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-inst" class="col-sm-4 control-label">Instagram</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" id="producer-inst" placeholder="Insert URL" name="instagram" value="{{dataProducer[0].producerInstagram}}"></input>
					</div>
				</div>
			</div>
			<div class="col-md-5">
				<div class="form-group">
					<label for="producer-profile" class="col-sm-12 control-label" style="text-align: left;">Image Profile *</label>
					<div class="col-sm-12">
						<input type="file" class="form-control" id="producer-profile" name="producerProfileImage" value="{{dataProducer[0].producerProfileImage}}"></input>
					</div>
				</div>
				<div class="form-group">
					<label for="producer-cover" class="col-sm-12 control-label" style="text-align: left;">Producer Cover *</label>
					<div class="col-sm-12">
						<input type="file" class="form-control" id="producer-cover" name="producerCoverImage" value="{{dataProducer[0].producerCoverImage}}"></input>
					</div>
				</div>
