...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2016 a las 12:55:59
...
CREATE TABLE IF NOT EXISTS `adminuser` (
  ...
  `adminName` char(64) CHARACTER SET utf8 NOT NULL,
  `adminLastName` varchar(68) CHARACTER SET utf8 NOT NULL,
  `adminPassword` char(64) CHARACTER SET utf8 NOT NULL,
  `adminUserEmail` varchar(45) CHARACTER SET utf8 NOT NULL,
...
(1, 'General', 'General', '$2y$10$1bPcIx0iQgbD5gzYfoFkhe4sgJI4NDgKfEnTPCA9jeJSD.kncRBVO', 'General@General.General', '2016-06-10 11:22:57', 1);
...
CREATE TABLE IF NOT EXISTS `bannerbeerslider` (
  ...
  `bannerImage` varchar(450) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bannersliderhome` (
  ...
  `bannerSliderHomeImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `bannerSliderHomeUrl` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
...
(1, '20160610123130', 'http://www.thebeerfans.com/blog/spanish/', 1),
(2, '20160610123137', 'http://www.thebeerfans.com/blog/spanish/', 1),
(3, '20160610123146', 'http://www.thebeerfans.com/blog/english/', 0),
(4, '20160610123152', 'http://www.thebeerfans.com/blog/english/', 0);
...
CREATE TABLE IF NOT EXISTS `bannerslidernew` (
  ...
  `bannerSliderNewTitle` varchar(45) CHARACTER SET latin1 NOT NULL,
  `bannerSliderNewSubtitle` varchar(45) CHARACTER SET latin1 NOT NULL,
  `bannerSliderNewDescription` varchar(450) CHARACTER SET latin1 NOT NULL,
  `bannerSliderNewUrl` varchar(450) CHARACTER SET latin1 NOT NULL,
  `bannerSliderNewImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `language` tinyint(1) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `bannerslidernew` (`idBannerSliderNew`, `bannerSliderNewTitle`, `bannerSliderNewSubtitle`, `bannerSliderNewDescription`, `bannerSliderNewUrl`, `bannerSliderNewImage`, `language`) VALUES
(1, 'Neque porro quisquam est qui dolorem ', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/spanish/', '20160610123721', 1),
(2, 'Neque porro quisquam est qui dolorem	2', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/spanish/	', '20160610123738', 1),
(3, 'Neque porro quisquam est qui dolorem', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/english/', '20160610123913', 0),
(4, 'Neque porro quisquam est qui dolorem	2', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/english/	', '20160610123929', 0);
...
CREATE TABLE IF NOT EXISTS `bannersliderpost` (
  ...
  `bannerSliderPostTitle` varchar(45) CHARACTER SET latin1 NOT NULL,
  `bannerSliderPostSubtitle` varchar(45) CHARACTER SET latin1 NOT NULL,
  `bannerSliderPostDescription` varchar(450) CHARACTER SET latin1 NOT NULL,
  `bannerSliderPostUrl` varchar(450) CHARACTER SET latin1 NOT NULL,
  `bannerSliderPostImage` varchar(450) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `bannersliderpost` (`idBannerSliderPost`, `bannerSliderPostTitle`, `bannerSliderPostSubtitle`, `bannerSliderPostDescription`, `bannerSliderPostUrl`, `bannerSliderPostImage`, `language`) VALUES
(1, 'Neque porro quisquam est qui dolorem	', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/spanish/	', '20160610124058', 1),
(2, 'Neque porro quisquam est qui dolorem 2	', 'Neque porro quisquam est qui dolorem 2	', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/spanish/	', '20160610124155', 1),
(3, 'Neque porro quisquam est qui dolorem	', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/english/', '20160610124229', 0),
(4, 'Neque porro quisquam est qui dolorem	', 'ipsum quia dolor sit amet, consectetur, adipi', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris risus turpis, maximus eu orci eu, volutpat suscipit elit. Suspendisse potenti. Sed pharetra consectetur lorem eget finibus. Etiam blandit ut odio vitae aliquam. Nam suscipit, nulla non interdum lacinia, est risus pellentesque velit, in ullamcorper augue magna ac nunc. Praesent pellentesque ante est, eget blandit lacus venenatis eget. Etiam malesuada eros nec varius commodo. Vivamus f', 'http://www.thebeerfans.com/blog/english/', '20160610124249', 0);
...
CREATE TABLE IF NOT EXISTS `beer` (
  ...
  `beerName` varchar(45) CHARACTER SET latin1 NOT NULL,
  `beerDescription` varchar(560) CHARACTER SET latin1 NOT NULL,
  `beerStrength` varchar(45) CHARACTER SET latin1 NOT NULL,
  `beerIBUS` varchar(45) CHARACTER SET latin1 NOT NULL,
  `beerProfileImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `beerCoverImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `beerBottleImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `beerSite` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `beerFacebook` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `beerTwitter` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cities` (
  `id` int(11) NOT NULL,
  `name_city` varchar(150) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `countries` (
  `id` int(11) NOT NULL,
  `sortname` varchar(4) CHARACTER SET latin1 NOT NULL,
  `name_c` varchar(150) CHARACTER SET latin1 NOT NULL
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `messageText` varchar(540) CHARACTER SET latin1 NOT NULL,
...
(1, 'Welcome to the beer fans, we hope you enjoy your experience on our site. There are a lot of surprises so stay with us!', '2016-06-10 12:47:22', 0, 1, 1),
(2, 'Welcome to the beer fans, we hope you enjoy your experience on our site. There are a lot of surprises so stay with us!', '2016-06-10 12:52:50', 1, 2, 1);
...
CREATE TABLE IF NOT EXISTS `postelement` (
  ...
  `postElementComment` varchar(550) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `producer` (
  `idProducer` int(11) NOT NULL,
  `producerName` varchar(45) CHARACTER SET latin1 NOT NULL,
  `producerDescription` varchar(560) CHARACTER SET latin1 NOT NULL,
  `producerAddress` varchar(150) CHARACTER SET latin1 NOT NULL,
  `producerZip` varchar(8) CHARACTER SET latin1 NOT NULL,
  `producerPhone` varchar(20) CHARACTER SET latin1 NOT NULL,
  `producerEmail` varchar(45) CHARACTER SET latin1 NOT NULL,
  `producerProfileImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `producerCoverImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `producerSite` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `producerFacebook` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `producerTwitter` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `producerInstagram` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `producertype` (
  `idProducerType` int(11) NOT NULL,
  `producerTypeName` varchar(45) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `rawmaterial` (
  ...
  `rawMaterialName` varchar(45) CHARACTER SET latin1 NOT NULL,
  `rawMaterialGeneralDescription` varchar(560) CHARACTER SET latin1 NOT NULL,
  `rawMaterialDescription` varchar(560) CHARACTER SET latin1 NOT NULL,
  `rawMaterialDescriptionHTML` varchar(1260) CHARACTER SET latin1 NOT NULL,
  `rawMaterialLatitude` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
  `rawMaterialLongitude` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
  `rawMaterialAddress` varchar(150) CHARACTER SET latin1 NOT NULL,
  `rawMaterialZip` varchar(8) CHARACTER SET latin1 NOT NULL,
  `rawMaterialPhone` varchar(20) CHARACTER SET latin1 NOT NULL,
  `rawMaterialEmail` varchar(45) CHARACTER SET latin1 NOT NULL,
  `rawMaterialProfileImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `rawMaterialCoverImage` varchar(450) CHARACTER SET latin1 NOT NULL,
  `rawMaterialSite` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `rawMaterialFacebook` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `rawMaterialTwitter` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `rawMaterialInstagram` varchar(450) CHARACTER SET latin1 DEFAULT NULL,
  `language` tinyint(1) NOT NULL,
  `country_id` int(11) NOT NULL,
  `state_id` int(11) NOT NULL,
  `city` varchar(45) CHARACTER SET latin1 NOT NULL
...
CREATE TABLE IF NOT EXISTS `rawmaterialtype` (
  ...
  `rawMaterialTypeName` varchar(45) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `states` (
  `id` int(11) NOT NULL,
  `name_s` varchar(150) CHARACTER SET latin1 NOT NULL,
  `country_id` int(11) NOT NULL
...
(1, '2016-06-10', 'The Beer Fans', 'Social', '1980-12-01', '', '20160610125120', 'cover_default.png', 'lic.felipefr@hotmail.com', '$2y$10$Yvu1zVmPa64Fp0TUXq5fBeOQF.IR/BamGZZS78S2JakltE5fFhHjW', 1, 0, 10, 142, 2441, 1, 1, 1, 1, 1),
(2, '2016-06-10', 'Guillermo', 'Camarena Miramontes', '1993-09-21', '', '20160610125451', '20160610125503', 'memo.9321@gmail.com', '$2y$10$9XjfQ.l3ykF7IolxHNITvem8jvQCjYLeUpghFkMXok.8VSZBxR6ha', 1, 1, 20, 142, 2441, 2, 2, 2, 2, 2);
...
--
ALTER TABLE `bannerslidernew`
  MODIFY `idBannerSliderNew` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `favoriteslist`
  MODIFY `idFavoritesList` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `inbox`
--
ALTER TABLE `inbox`
  MODIFY `idInbox` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `publicmessageslist`
  MODIFY `idPublicMessagesList` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `rankslist`
--
ALTER TABLE `rankslist`
  MODIFY `idRanksList` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
